...
public:
	...
	*/ 
    ...
    int ReadBufferTildeNew(t_buffer_ref *bufref, int num, int sourceChannel, int resize, float offsetTime, float sizeTime);
	...
	*/ 
    ...
    // vb: use new buffer api
    int WriteBufferTildeNew(t_buffer_ref *bufref, int num, int targetChannel, float offsetTime, float sizeTime);
